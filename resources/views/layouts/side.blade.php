        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-princeton">
            ...
            <ul class="space-y-2 font-medium">
                ...
                @if (Auth::user()->rol === 'DIRECTOR' || Auth::user()->rol === 'COORDINADOR')
                    ...
                    <li>
                        <a href="{{ route('admin.pda.index') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group {{ request()->routeIs('admin.pda.index') ? 'bg-gray-700' : '' }}">
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">PDA</span>
                        </a>
                    </li>
                ...
                @elseif (Auth::user()->rol === 'MAESTRO')
                    ...
                    {{-- ENLACE PARA PDA (MAESTRO) --}}
                    <li>
                        <a href="{{ route('admin.pda.index') }}" 
                           class="flex items-center p-2 text-white rounded-lg group {{ request()->routeIs('admin.pda.index') ? 'bg-gray-700' : 'hover:bg-gray-700' }}">
                            <svg class="shrink-0 w-5 h-5 text-white-500 transition duration-75 group-hover:text-gray-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <span class="flex-1 ms-3 whitespace-nowrap">PDA</span>
