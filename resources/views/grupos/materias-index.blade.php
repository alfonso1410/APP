<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            {{-- El botón y la ruta cambian según el tipo de grupo --}}
            @if ($grupo->tipo_grupo === 'REGULAR')
                {{-- Para grupos regulares, el siguiente paso es asignar maestros --}}
            ...
            @else
                {{-- Para grupos extra, sí se asignan las materias --}}
