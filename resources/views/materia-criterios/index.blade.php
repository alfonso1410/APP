...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center" x-data="{ currentCriterio: {} }">
            ...
            <div class="flex space-x-4">
                ...
                {{-- Botón Crear Criterio (Abre Modal) --}}
    ...
    {{-- Inicializamos currentCriterio en el body para la edición --}}
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end items-center space-x-2">
                                                    ...
                                                    {{-- ✅ Botón Editar (SINTAXIS CORREGIDA) --}}
                                                    <button
                                                        x-on:click.prevent='
                                                            $dispatch("open-modal", "edit-criterio"); 
                                                            // Usamos json_encode() para serializar el array de PHP
